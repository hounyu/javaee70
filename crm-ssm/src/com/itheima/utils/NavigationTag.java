...
public class NavigationTag extends TagSupport {
    ...
    private String resolveUrl(String url, javax.servlet.jsp.PageContext pageContext) throws JspException{
    	...
    	for (Object key:params.keySet()) {
    		...
    		/*if(key.toString().contains("custName")){
    			try {
    		...
    		if (value.getClass().isArray()) {
    			//value = (String[])value;
    			try {
					((String[])value)[0] = new String(((String[])value)[0].getBytes("iso8859-1"), "utf-8");
				} catch (UnsupportedEncodingException e) {
					e.printStackTrace();
				}
    			...
    			try {
    				valueStr = new String(value.toString().getBytes("iso8859-1"), "utf-8");
				} catch (UnsupportedEncodingException e) {
					e.printStackTrace();
				}
    			url = append(url, key.toString(),valueStr);
    		}
    	}
        return url;
    }
